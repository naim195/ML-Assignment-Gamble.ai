...
train_path = "human+activity+recognition+using+smartphones/UCI HAR Dataset/UCI HAR Dataset/train"
test_path = "human+activity+recognition+using+smartphones/UCI HAR Dataset/UCI HAR Dataset/test"
